      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-2xl p-12 mb-8 text-white">
          ...
          <p className="text-xl text-white/90 mb-6">
            Este sistema utiliza un sensor DHT22 para monitorear en tiempo real
            la temperatura y la humedad, mostrando los datos en una pantalla LCD
            y en esta página web con indicadores y gráficas dinámicas. Su
            propósito es ofrecer una forma práctica y visual de supervisar las
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              Monitoreo en tiempo real con gráficas históricas
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition">
            ...
            <p className="text-gray-600">
              3 LEDs controlables desde la interfaz
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Indicadores visuales controlables
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">
                  Entrada de datos y control manual
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-4">
